...
**NYTArticleSearch** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [ ] For different news articles that only have text or only have images, use [Heterogenous Layouts](http://guides.codepath.com/android/Heterogeneous-Layouts-inside-RecyclerView) with RecyclerView
...
<img src='https://github.com/rakheegupta/NYT-Article-Search/blob/master/nyt_port.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
